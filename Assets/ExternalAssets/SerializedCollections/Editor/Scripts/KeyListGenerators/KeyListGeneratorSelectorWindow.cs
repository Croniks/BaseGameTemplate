...
namespace AYellowpaper.SerializedCollections.KeysGenerators
{
    public class KeyListGeneratorSelectorWindow : EditorWindow
    {
        ...
        {
            VisualTreeAsset document = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/ExternalAssets/SerializedCollections/Editor/Assets/KeysGeneratorSelectorWindow.uxml");
